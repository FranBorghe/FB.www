...
<head>
    ...
    <title>Informazioni PHP - FRANCESCO BORGHETTI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per FRANCESCO BORGHETTI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> FRANCESCO BORGHETTI</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> borghhetti.francesco</p>
